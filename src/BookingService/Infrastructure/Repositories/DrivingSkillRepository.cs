...
{
    public class DrivingSkillRepository : GenericRepository<DrivingSkill>, IDrivingSkillRepository
    {
        public DrivingSkillRepository(BookingDbContext context) : base(context)
        {
        }
