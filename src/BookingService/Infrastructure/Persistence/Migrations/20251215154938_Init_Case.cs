        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_rental_car = table.Column<bool>(type: "boolean", nullable: false),
                    updated_at = table.Column<DateTime>(type: "timestamp", nullable: false, defaultValueSql: "now()"),
                    is_deleted = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    instructor_id = table.Column<Guid>(type: "uuid", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp", nullable: false, defaultValueSql: "now()")
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    price_for_car = table.Column<decimal>(type: "numeric", nullable: true),
                    ...
                    display_start_location_name = table.Column<string>(type: "text", nullable: false),
                    ...
                    display_end_location_name = table.Column<string>(type: "text", nullable: false),
                    end_lat = table.Column<decimal>(type: "numeric", nullable: false),
                    end_long = table.Column<decimal>(type: "numeric", nullable: false),
                    polyline_sesion_route = table.Column<string>(type: "text", nullable: true),
                    polyline_sesion_log = table.Column<string>(type: "text", nullable: true),
