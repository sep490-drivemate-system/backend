...
namespace UserService.Application.UseCases
{
    public class AuthUseCase : IAuthUseCase
    {
        ...
        public AuthUseCase(IUnitOfWork unitOfWork, IPasswordHasherService passwordHasherService, IEmailService emailService,  IMapper mapper, IJwtService jwtService)
        {
